...
public class Player : StateContext
{
    ...
    public PlayerInputReceiver Input{get{return _inputReceiver;}}
    ...
    public CinemachineVirtualCamera AimCamera{get{return _aimCamera;}}

    private AimComponent _aimComponent;
    public AimComponent AimComponent{get{return _aimComponent;}}
